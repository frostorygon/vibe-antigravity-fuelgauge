...
[![Version](https://img.shields.io/open-vsx/v/jlcodes/antigravity-fuelgauge)](https://open-vsx.org/extension/jlcodes/antigravity-fuelgauge)
[![Downloads](https://img.shields.io/open-vsx/dt/jlcodes/antigravity-fuelgauge?color=success)](https://open-vsx.org/extension/jlcodes/antigravity-fuelgauge)
[![GitHub stars](https://img.shields.io/github/stars/jlcodes99/vscode-antigravity-fuelgauge?style=flat&color=gold)](https://github.com/jlcodes99/vscode-antigravity-fuelgauge)
[![GitHub issues](https://img.shields.io/github/issues/jlcodes99/vscode-antigravity-fuelgauge)](https://github.com/jlcodes99/vscode-antigravity-fuelgauge/issues)
[![License](https://img.shields.io/github/license/jlcodes99/vscode-antigravity-fuelgauge)](https://github.com/jlcodes99/vscode-antigravity-fuelgauge)
...
🇺🇸 English · 🇯🇵 日本語 · 🇩🇪 Deutsch · 🇪🇸 Español · 🇫🇷 Français · 🇮🇹 Italiano · 🇰🇷 한국어 · 🇧🇷 Português · 🇷🇺 Русский · 🇹🇷 Türkçe · 🇵🇱 Polski · 🇨🇿 Čeština · 🇸🇦 العربية · 🇻🇳 Tiếng Việt
...
1. **Open**:
   ...
   - Or `Ctrl/Cmd+Shift+Q`
   - Or run `Antigravity FuelGauge: Open Dashboard` from command palette
...
2. Search `Antigravity FuelGauge`
3. Click Install
...
```bash
# Clone repository
git clone https://github.com/jlcodes99/vscode-antigravity-fuelgauge.git
cd vscode-antigravity-fuelgauge
...
- ⭐ [GitHub Star](https://github.com/jlcodes99/vscode-antigravity-fuelgauge)
- 💬 [Report Issues](https://github.com/jlcodes99/vscode-antigravity-fuelgauge/issues)
...
[![Star History Chart](https://api.star-history.com/svg?repos=jlcodes99/vscode-antigravity-fuelgauge&type=Date)](https://star-history.com/#jlcodes99/vscode-antigravity-fuelgauge&Date)
